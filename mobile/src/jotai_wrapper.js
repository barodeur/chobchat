...
const { useAtomCallback } = require('jotai/utils')
...
exports.useAtomCallback = (callback) => {
  return useAtomCallback(useCallback((get, set, args) => {
    const getWithoutOptions = a => get(a, undefined);
    return callback({ get: getWithoutOptions, set, dispatch: set }, args);
  }, [callback]))
}
